...
import 
{ faPepperHot,faAppleWhole,faSeedling,faCartShopping,faHandshakeAngle,faListUl,faChevronDown } 
...
const Navber = (props) => {
  ...
  return (
    <Fragment>
      {/* Navber Section */}
      <nav className="fixed top-0 w-full z-20 shadow-lg lg:shadow-none bg-white bg-green-500">
        ...
        <ul className="containerMenu flex flex flex-row px-2  text-gray-100 text-sm">
          ...
          <li className="menu p-3 px-8 hover:bg-green-700">
            <span>
              <FontAwesomeIcon icon={faCartShopping} size="xs" />&nbsp;Đi chợ online&nbsp;
            </span>
          </li>
          <li className="menu p-3 px-4 hover:bg-green-700 dropdown">
              <span className="dropdown-btn">
                <FontAwesomeIcon icon={faAppleWhole} size="xs" />&nbsp;Hoa quả &nbsp;<FontAwesomeIcon icon={faChevronDown} size="xs"/>
              </span> 
              <DropdownMenu />
          </li>
          <li className="menu p-3 px-4 hover:bg-green-700 dropdown">
             <span className="dropdown-btn">
                <FontAwesomeIcon icon={faPepperHot} size="xs" /> &nbsp;Rau củ &nbsp;<FontAwesomeIcon icon={faChevronDown} size="xs"/>
            </span>
            <DropdownMenu />
          </li>
          <li className="menu p-3 px-4 hover:bg-green-700 dropdown">
          <span className="dropdown-btn">
            ...
            &nbsp;Đặc sản &nbsp;<FontAwesomeIcon icon={faChevronDown} size="xs"/>
          </span>
          <DropdownMenu />
          </li>
          <li className="menu p-3 px-4 hover:bg-green-700">
          <span className="dropdown-btn" 
            onClick={(e) => history.push("/contact-us")}
          >
